    ...
    <div className="fixed inset-0 bg-white text-black bg-opacity-50 flex justify-center items-center p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="overflow-y-auto p-4">
          ...
          <p>
            At ©CarRental, we prioritize your privacy and are committed to
          ...
          <ul className="list-disc pl-5">
            <li>
              ...
              address, payment information, and government-issued identification
            ...
            <li>
              Device Information: Data about the devices you use to access our
              platform, such as IP address, browser type, and operating system.
            </li>
            <li>
              Location Data: With your consent, we may collect geolocation data
              for certain features, like showing nearby rental options.
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5">
            <li>
              To process transactions, including vehicle purchases, sales, and
              rentals.
            </li>
            <li>
              To improve and personalize your experience, including through
              tailored recommendations and support.
            </li>
            <li>
              For security purposes, to detect and prevent fraud, and to ensure
              compliance with our Terms & Conditions.
            </li>
            <li>
              To communicate with you about updates, promotions, and relevant
              information related to our services (with your consent).
            </li>
          </ul>
          ...
          <ul className="list-disc pl-5">
            <li>
              With our trusted partners for transaction processing, customer
              support, and site analytics.
            </li>
            <li>
              With regulatory authorities or as required by law, such as in
          ...
          <ul className="list-disc pl-5">
            <li>
              Access and Correction: You may access and correct your personal
              information in your account settings.
            </li>
            <li>
              Deletion: You can request the deletion of your data where legally
              permissible.
            </li>
            <li>
