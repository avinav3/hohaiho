...
export default function RentCarDetails() {
  ...
  const calculateTotalPrice = () => {
    ...
    if (rentalPeriod === "weekly")
      basePrice = Math.ceil(days / 7) * rentalRates.weekly;
    if (rentalPeriod === "monthly")
      basePrice = Math.ceil(days / 30) * rentalRates.monthly;
                ...
                <div className="bg-gray-50 dark:bg-gray-700 rounded-3xl p-8">
                  ...
                  <div className="space-y-6 text-lg mb-2">
                    <p className="text-gray-700 mb-4 dark:text-gray-100">
                      This {car.year} {car.make} {car.model} is in excellent
                      condition and regularly maintained. It has undergone a
                      thorough inspection and detailing process to ensure a
                  ...
                  <div className="space-y-4 dark:text-gray-100">
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        150 miles per day included. ₹0.25 per additional mile.
                      </p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">
                        Basic insurance included. Additional coverage available.
                      </p>
                    </div>
                    <button
                ...
                <div className="bg-gray-50 dark:bg-gray-700 rounded-3xl p-8">
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <span className="ml-2 text-gray-600">
                      4.8 out of 5 (based on 47 reviews)
                    </span>
                  </div>
                    ...
                    <div className="border-b pb-4">
                      <div className="flex items-center mb-2">
                        ...
                        <span className="ml-2 text-sm text-gray-600">
                          John D. - Rented for 3 days
                        </span>
                      </div>
                      <p className="text-gray-700">
                        Great car! Very clean and well-maintained. The pickup
                        and drop-off process was smooth. Would definitely rent
                        again.
                      </p>
                    </div>
                    <div className="border-b pb-4">
                      <div className="flex items-center mb-2">
                        ...
                        <span className="ml-2 text-sm text-gray-600">
                          Sarah M. - Rented for 1 week
                        </span>
                      </div>
                      <p className="text-gray-700">
                        The car was comfortable for our family trip. Fuel
                        efficiency was great. Only minor issue was a slight
                        delay at pickup.
                      </p>
                    </div>
                  </div>
